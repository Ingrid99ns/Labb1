...
public class Labb1Test {
    ...
    public void testIncrementSpeed() {
        Volvo240 volvo = new Volvo240();
        volvo.startEngine();
        volvo.incrementSpeed(126);
        assertTrue(volvo.getCurrentSpeed() == 125);
        ...
        Saab95 saabTwo = new Saab95();
        saabTwo.startEngine();
        saabTwo.incrementSpeed(126);
        assert (saabTwo.getCurrentSpeed() == 125);
    ...
    public void testDecrementSpeed() {
        ...
        Saab95 saabTwo = new Saab95();
        saabTwo.startEngine();
        saabTwo.decrementSpeed(-1);
        assertTrue(saabTwo.getCurrentSpeed() == 0);
    ...
    public void testBrake() {
        ...
        assertTrue(volvo.currentSpeed == 0); // 0.1 - 1.25(speedFactor)
    }
    ...
    public void TestplatformAngleInterval() {
        ...
        Scania640 scaniaTwo = new Scania640();
        scaniaTwo.platformAngleInterval(90);
        scaniaTwo.getAnglePlatform();
        assertTrue(scaniaTwo.getAnglePlatform() == 70);
    }
